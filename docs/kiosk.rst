...
Данная функция доступна только на семействе ОС Альт. За основу взята `статья <https://www.altlinux.org/index.php?title=Киоск&oldid=57563>`_.
