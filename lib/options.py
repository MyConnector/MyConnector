...
class Properties(Gtk.Window):
    ...
    def initParameters(self):
        ...
        try: self.checkGlobal.set_active( CONFIG.getboolean( "system_config" ) )
        except ( KeyError, TypeError ): self.checkGlobal.set_active( DEFAULT[ "system_config" ] )
        try: self.checkGlobalDir.set_active( CONFIG.getboolean( "system_folder" ) )
        except ( KeyError, TypeError ): self.checkGlobalDir.set_active( DEFAULT[ "system_folder" ] )
        try: self.checkStealth.set_active( CONFIG.getboolean( "stealth_mode"  ) )
        except ( KeyError, TypeError ): self.checkStealth.set_active( DEFAULT[ "stealth_mode" ] )
